...
<html lang="en">
   <head>
      ...
      <!-- mobile metas -->
      <meta name="viewport" content="width=device-width, initial-scale=1">
      <title>Diagram Redesigned</title>
      <!-- Fonts -->
   ...
   <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark">
         <div class="container">
            <a class="navbar-brand" href="#">Diag</a>
         ...
         <div class="container h-100 d-flex align-items-center">
            <div class="row w-100">
               ...
               <div class="col-md-6 d-flex justify-content-center align-items-center">
                  <img src="{{asset('landing/images/box_img.png')}}" alt="Diagram illustration" class="img-fluid">
               </div>
            </div>
         </div>
      </section>
      ...
      <footer>
         <div class="container">
            ...
            <p>Copyright 2025 - Diagram App</p>
         </div>
      </footer>
      <!-- Scripts -->
